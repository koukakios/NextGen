...
class BCINeuralNetClassifier:
    def __init__(self, n_components=4):
        """
        Initializes a pipeline with Common Spatial Patterns and a Neural Network.
        """
...
if __name__ == "__main__":
    ...
    for file in training_files:
        ...
        try:
            ...
            print("Training CSP + Neural Network model...")
            bci_model = BCINeuralNetClassifier(n_components=4)
